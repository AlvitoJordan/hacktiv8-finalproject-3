...
const Card = ({ type, title, icon, onPress, name, city, price, image,favorite,data }) => {
  switch (type) {
    case "hotel":
    ...
    case "favorite":
      return (
        <CardFavorite name={name} city={city} price={price} image={image} favorite={favorite} onPress={onPress} data={data} />
      );
  }
};
